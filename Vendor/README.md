...
## AetherEngine (pin 5.14.1)

Local pin of [AetherEngine 5.14.1](https://github.com/superuser404notfound/AetherEngine/releases/tag/5.14.1) with imports rewritten to the namespaced FFmpeg modules below.

## FFmpegBuild (based on 2.1.3, namespaced)

Local pin of [FFmpegBuild 2.1.3](https://github.com/superuser404notfound/FFmpegBuild/tree/2.1.3) with frameworks/modules renamed to `AetherLib*` so they can embed next to MPVKit’s `Libav*` stack in the same app binary.
