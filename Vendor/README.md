...
Local pin of [FFmpegBuild 2.4.3](https://github.com/superuser404notfound/FFmpegBuild/tree/2.4.3) with frameworks/modules renamed to `AetherLib*` so they can embed next to MPVKit’s `Libav*` stack in the same app binary.
